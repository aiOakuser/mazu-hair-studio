...
- **Logotype** ("Maria Hair Studio" in the header): a refined serif or
...
- **No description**: card omits the description block entirely (don't
  reserve empty space) — visible in the reference (e.g. "Maria's Men's
