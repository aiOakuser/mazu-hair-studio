# Maria Hair Studio — Project Plan

A booking/service-menu website for a single-location hair salon (Maria Hair
...
### A · Header
- Centered wordmark "Maria Hair Studio" (serif/script-leaning logotype,
